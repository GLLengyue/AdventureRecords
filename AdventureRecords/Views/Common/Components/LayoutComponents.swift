...
public struct ModuleNavigationBar<TrailingContent: View>: View {
    ...
    init(title: String, module: ModuleType, backAction: (() -> Void)? = nil,
...
public struct ListContainer<Content: View, TrailingContent: View>: View {
    ...
    public var body: some View {
        VStack(spacing: 0) {
            ModuleNavigationBar(title: title,
                                module: module,
                                trailingContent: {
                                    HStack(spacing: 8) {
                                        trailingContent
...
public struct DetailContainer<Content: View>: View {
    ...
    init(module: ModuleType, title: String, backAction: @escaping () -> Void, editAction: (() -> Void)? = nil,
         @ViewBuilder content: () -> Content)
    {
        self.module = module
        self.title = title
...
public struct EditorContainer<Content: View>: View {
    ...
    init(module: ModuleType, title: String, cancelAction: @escaping () -> Void, saveAction: @escaping () -> Void,
         saveDisabled: Bool = false, @ViewBuilder content: () -> Content)
    {
        self.module = module
        self.title = title
