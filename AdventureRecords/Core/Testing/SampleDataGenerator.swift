...
enum SampleDataGenerator {
    ...
    private static func initializeDebugData() {
        // 创建角色
        var alice = shared.createCharacter(
            name: "艾莉丝",
            description: "一位勇敢的冒险者",
            avatar: nil
        )
        
        var reinhart = shared.createCharacter(
            name: "莱因哈特",
            description: "神秘的吟游诗人",
            avatar: nil
        )
        ...
        // 创建场景
        var ruins = shared.createScene(
            title: "古老遗迹",
            description: "充满谜团的遗迹遗址。"
        )
        
        var plaza = shared.createScene(
            title: "王都广场",
            description: "热闹非凡的城市中心。"
        )
        
        // 创建笔记
        var firstMeeting = shared.createNote(
            title: "初遇",
            content: "主角在酒馆邂逅神秘人。"
        )
        
        var exploration = shared.createNote(
            title: "遗迹探索",
